...
If you would like to run this website yourself, you can do so for free on Heroku. Keep in mind, it is a work in progress and some features do not work correctly yet (see below).
...
Now you can visit localhost:3000 in your web browser and log in as anyone listed in db/people.csv using the password 'testing'.
